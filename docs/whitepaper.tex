...
Our goal is to teach children about $3^{rd}$ grade to
$7^{th}$ grade about the critical thinking skills involved in the cybersecurity
field. While some of the concepts are (hopefully) not prevalent in
production today, they represent the same type of problem solving mindset that
